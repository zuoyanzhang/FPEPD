...
double getULP2(double x1, double x2, double origin) {
	...
	mpfr_set_d(mp4, 1.1234139999999999, MPFR_RNDN);
	mpfr_sub(mp5, mp3, mp4, MPFR_RNDN);
	mpfr_set_d(mp6, x1, MPFR_RNDN);
	mpfr_set_d(mp7, x2, MPFR_RNDN);
